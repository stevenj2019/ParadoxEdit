...
#     def __init__(self, app_controller:AppController, file:FileReference):
#         super().__init__()
...
#         sprites = []
#         def image_collection_loop(sprites:list, path:Path):
#             path = Path(path) #remove this when i fix import
#             if path.is_dir():
