...
#         for node in nodes:
#             # print("MODEL", node, id(node))
#             # print("TRACKED", node in self.app_controller.file_system.change_tracker.node_changes)
#             effective_state = (
#                 inherited_state 
#                 or self.app_controller.file_system.change_tracker.get_node_state(node)
#             )
#             print(node, effective_state, inherited_state)
#             # print("UI DATA", )
#             match node:
#                 case GenericBlock():
...
#         effective_state = inherited_state if inherited_state else self.app_controller.file_system.change_tracker.get_node_state(node)
#         context = open_file_context.derive_node_context(node)
