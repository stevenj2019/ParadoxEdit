...
# def country_event_block(event_id=None) -> None:
...
# def news_event_block(event_id=None) -> None:
#     event_id = event_id if event_id else None
...
# def event_essentials(event_id=None) -> None:
...
# #  EVENT BLOCKS  #
# ###            ###
# def immediate_block() -> None:
#     return GenericBlock("immediate",[
#         GenericComment("##YOUR CODE HERE")
#     ])

# def option_block(option_name=None)-> None:
